    ...
    <div class="flex flex-col w-full gap-5">
        ...
        <div class="w-full flex justify-center gap-5">
            <div class="flex flex-col gap-5">
                <div class="bg-[#f5f5f5] w-64 h-32"></div>
                <div class="bg-[#f5f5f5] w-64 h-96"></div>
                <div class="bg-[#f5f5f5] w-64 h-52"></div>
                <div class="bg-[#f5f5f5] w-64 h-32"></div>
                <div class="bg-[#f5f5f5] w-64 h-44"></div>
            </div>
            <div class="flex flex-col gap-5">
                <div class="bg-[#f5f5f5] w-64 h-64"></div>
                <div class="bg-[#f5f5f5] w-64 h-32"></div>
                <div class="bg-[#f5f5f5] w-64 h-52"></div>
                <div class="bg-[#f5f5f5] w-64 h-32"></div>
                <div class="bg-[#f5f5f5] w-64 h-44"></div>
